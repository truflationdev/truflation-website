...
<template>
     <div class="flex flex-row flex-wrap gap-5 mx-auto container my-5 items-center justify-center p-6 rounded bg-slate-100">
                ...
                <div class="flex flex-row">
                    <input class="lg:ml-auto h-fit px-5 py-3 rounded-2xl border-gray-10 border" type="text" placeholder="John@gmail.com">
