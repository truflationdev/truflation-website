...
<template>
    <div class="flex flex-row flex-wrap lg:flex-nowrap container items-center justify-center mx-auto">
        <div class="flex flex-col bg-gradient-to-r justify-center  from-[#3573E7] to-[#2463DB] p-8 content-center rounded-lg items-center">
            <div class="flex flex-row justify-evenly items-center gap-8">
               ...
               <div class="flex flex-col">
                <p class="text-white text-lg font-bold">{{ selectedCountry }} Truflation </p>
            ...
            <div class="flex flex-row mt-12 gap-3 items-center">
               <p class=" text-white text-6xl font-semibold">{{main?.getHighAndLow().Inflation}}%</p>
            ...
            <div class="text-white w-full px-2 py-1 mt-2 text-center bg-[#F59E0B] rounded-lg">US govt reported rate: 6.5%</div> 
            <div class="flex flex-col w-full">
              <div class=" bg-slate-100 w-full bg-opacity-50 mt-[60px] rounded-full relative h-3" >
        ...
        <div class="hidden sm:flex flex-col w-full md:w-2/3 ml-3 bg-slate-100 p-5 gap-4 rounded-sm">
