...
<template>
  ...
  <div class="">
    ...
    <!-- <div class="flex container mx-auto">
      <div
        class="flex text-center md:text-left flex-col w-full relative bg-truflation-100 items-center mt-10 py-20 md:pl-10 lg:flex-row"
      >
        <div class="flex flex-col gap-5 h-full">
          <div class="flex flex-col items-center md:items-start">
            ...
            <p class="mt-4 max-w-md">
              Truflation offers independent and censorship-resistant inflation
              calculations based on census level price information.
            </p>
            <button class="mt-4 btn">
              <a
                class="flex flex-row items-center gap-2"
                href="https://marketplace.truflation.com/"
                >Visit Marketplace
                <svg
                  width="14"
                  height="12"
        ...
        <img
          class="absolute z-0 bottom-0 -right-0 invisible md:visible"
    ...
    <div
      class="container mx-auto text-left md:text-center md:text-base flex flex-col gap-5 md:mt-12"
    >
      <div
        class="flex flex-col md:flex-row items-center mx-2 md:mx-auto mt-3 gap-3"
      >
        <h2 class="text-4xl font-semibold">Today's CPI Data by</h2>
    ...
    <div class="container md:mx-auto flex flex-row flex-wrap gap-10 mt-20">
      <div
        class="flex flex-row mx-auto text-white bg-gradient-to-br from-truflation-600 to-truflation-300 rounded-md"
      >
      ...
      <div
        class="flex flex-row w-full md:w-auto md:mx-auto bg-[#F0F4FA] rounded-md"
      >
