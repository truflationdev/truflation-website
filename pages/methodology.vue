...
<template>
  ...
  >
    <Banner :isLight="true" />
    <div
      class="items-center mx-10 py-20 md:mx-auto lg:items-start flex flex-col lg:px-40 xl:py-32"
    >
    ...
    <div class="flex flex-col flex-wrap mt-16 justify-center items-center">
      <div class="flex text-center md:text-left flex-col gap-4 h-full my-4">
        ...
        <div class="flex mt-4 flex-row flex-wrap gap-8">
          <ul
            class="grid sm:grid-cols-2 lg:grid-cols-4 gap-16 w-full items-center justify-center"
          >
            <li
  ...
  <div
    class="flex flex-col h-full justify-center text-center md:text-left items-center my-12 mx-auto"
  >
